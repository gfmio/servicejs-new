/**
 * Node.js Worker Threads runtime types
 */
...
export interface ParentPortCapability {
  postMessage(message: any, transferList?: any[]): Result<void, MessageError>;
  onMessage(handler: (message: any) => void): () => void;
  close(): void;
}

export interface MessageError {
  readonly code: 'POST_FAILED' | 'NO_PARENT_PORT';
  readonly message: string;
}

export interface NodeWorkerRuntimeCapabilities {
