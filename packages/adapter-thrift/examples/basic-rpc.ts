...
/**
 * Basic Thrift RPC Example
 *
 * This example demonstrates a simple calculator service using the Thrift adapter.
 * Run with: bun run examples/basic-rpc.ts
 */

import { createThriftServer, createThriftClient } from '../src/index';
...
async function main() {
  ...
  console.log('Thrift RPC Calculator Example');
  console.log('═'.repeat(60));
  console.log();

  // Create and start server
  console.log('Starting Thrift server on port 9090...');
